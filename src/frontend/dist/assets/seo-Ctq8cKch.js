import { c as createLucideIcon } from "./index-Cxbb59_L.js";
/**
...
const articles = [
  {
    ...
    excerpt: "A deep dive into Brewer's conjecture — why you can only guarantee two of three properties (Consistency, Availability, Partition Tolerance) in any distributed data store, and what that means for real-world system design.",
    date: "2024-03-12",
    readTime: 12,
    tags: ["Distributed Systems", "CAP Theorem", "Consistency", "Architecture"],
...
CAP theorem isn't a limitation to work around — it's a lens for making explicit trade-offs. The engineer who understands CAP doesn't search for ways to "have all three." They build systems where consistency boundaries are intentional, availability is measured, and partition behavior is tested before production discovers it.`
  },
  {
    id: "2",
    slug: "database-sharding-strategies-at-scale",
    title: "Database Sharding Strategies at Scale",
    excerpt: "Horizontal partitioning is one of the most powerful — and most misunderstood — techniques for scaling databases. This post covers range-based, hash-based, and directory-based sharding, with hard-won lessons from operating sharded systems in production.",
    date: "2024-02-08",
    readTime: 15,
    tags: ["Databases", "Sharding", "Scalability", "PostgreSQL"],
    content: `## Why Sharding Exists
...
Sharding is the right tool for write-heavy workloads that exceed single-node capacity. For everything else, it's operational burden without commensurate benefit.`
  },
  {
    id: "3",
    slug: "eventual-consistency-models-explained",
    title: "Eventual Consistency Models Explained",
    excerpt: "Eventual consistency is not a single model — it's a spectrum. From monotonic reads to causal consistency to linearizability, understanding these models helps you choose the right guarantees for each part of your system.",
    date: "2024-01-22",
    readTime: 10,
    tags: ["Distributed Systems", "Consistency", "Databases", "System Design"],
    content: `## The Consistency Spectrum
...
4. **Profile before strengthening**. Upgrading from eventual to causal consistency can cost 2-5x in latency. Make sure the use case warrants it.`
  }
];
...
function getArticleJsonLD(opts) {
