const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-CDGH1Ghy.js","assets/proxy-2zPCDLCE.js","assets/seo-Ctq8cKch.js","assets/zap-Ccmikox4.js","assets/terminal-CGtpinTI.js","assets/BlogPost-F6MPlOTG.js","assets/NotFound-5r2LgzD8.js","assets/Runbook-5Aeuitu2.js"])))=>i.map(i=>d[i]);
...
const experiences = [
  {
    ...
    description: "Working on the core query optimizer for SingleStore's distributed SQL engine, focusing on high-throughput OLAP workloads and cross-shard query planning.",
    highlights: [
  ...
  },
  {
    ...
    period: "2019 – 2022",
    location: "Seattle, WA",
    description: "Contributed to Amazon RDS and Aurora PostgreSQL, working on storage engine internals, replication reliability, and automated failover mechanisms.",
    highlights: [
  ...
  },
  {
    ...
    description: "Designed and operated cloud-native infrastructure for enterprise clients migrating from on-premise data centers to AWS and Azure environments.",
    highlights: [
...
const philosophyPillars = [
  {
    ...
    description: "Every query matters. I treat database interactions with the gravity of revenue impact — because slow queries aren't just performance bugs, they're business failures waiting to happen. The difference between a 50ms and 500ms response is the difference between growth and churn."
  },
  {
    id: "fast-debugging",
    icon: "Zap",
    title: "Fast Debugging",
    description: "Distributed systems fail in creative ways. The skill that separates good engineers from great ones is developing intuition for root causes before the logs tell you. I invest in observability infrastructure precisely because it compresses the time between 'something is wrong' and 'here is why.'"
  },
  {
    id: "reliability-first",
    icon: "Shield",
    title: "Reliability Over Features",
    description: "Clever solutions that fail at 3 AM are not clever. I prioritize boring, proven infrastructure over novel approaches that introduce unknown failure modes. The right abstraction is one that keeps working when you've forgotten how it works."
  },
  {
    id: "knowledge-sharing",
    icon: "BookOpen",
    title: "Knowledge Sharing",
    description: "The best engineers raise the floor of the team, not just the ceiling of their own output. I write technical deep dives, review with context not just correctness, and document the decisions that will confuse future engineers — including future me."
  }
];
/**
...
function Footer() {
  ...
  const hostname = typeof window !== "undefined" ? window.location.hostname : "shahidster.tech";
  const caffeineUrl = `https://caffeine.ai?utm_source=caffeine-footer&utm_medium=referral&utm_content=${encodeURIComponent(hostname)}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border/50 mt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-12 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground tracking-tight", children: personalInfo.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary font-mono text-sm mt-1", children: [
            "// ",
            personalInfo.title
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base leading-relaxed max-w-xs", children: "Building systems that scale reliably. Writing about distributed systems, databases, and engineering culture." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground/60 uppercase tracking-widest", children: "Navigation" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-2", children: [
          { label: "Home", href: "/" },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground/60 uppercase tracking-widest", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 text-primary/60 group-hover:text-primary transition-colors" }),
                personalInfo.email
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "w-4 h-4 text-primary/60 group-hover:text-primary transition-colors" }),
                "LinkedIn",
                /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-3 h-3 opacity-50" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-muted-foreground text-base", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-primary/60" }),
            personalInfo.location
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "bg-border/40 mb-8" }),
...
function Header() {
  ...
  reactExports.useEffect(() => {
    return router2.subscribe("onLoad", () => setMobileOpen(false));
  }, [router2]);
  function handleNavClick(href, isPage, e) {
    if (!isPage && href.startsWith("/#")) {
      e.preventDefault();
      const sectionId = href.replace("/#", "");
      const currentPath = router2.state.location.pathname;
      if (currentPath !== "/") {
        window.location.href = href;
      } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: cn(
        ...
        isScrolled ? "bg-card/90 backdrop-blur-md border-b border-border/60 shadow-lg" : "bg-transparent"
      ),
      "data-ocid": "nav-header",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/",
              ...
              "data-ocid": "nav-logo",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded flex items-center justify-center transition-all duration-200 group-hover:drop-shadow-[0_0_8px_oklch(0.7_0.22_200/0.7)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm text-foreground tracking-tight block", children: "Shahid Moosa" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-primary/70 block", children: "// db.support" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "nav",
            {
              ...
              children: [
                navLinks.map(
                  (link) => link.isPage ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      to: link.href,
                      className: cn(
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card/95 backdrop-blur-md border-b border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "nav",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:connect2shahidmoosa@gmail.com", className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
...
const Home = reactExports.lazy(() => __vitePreload(() => import("./Home-CDGH1Ghy.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const BlogPost = reactExports.lazy(() => __vitePreload(() => import("./BlogPost-F6MPlOTG.js"), true ? __vite__mapDeps([5,1,2]) : void 0));
const NotFound = reactExports.lazy(() => __vitePreload(() => import("./NotFound-5r2LgzD8.js"), true ? __vite__mapDeps([6,4]) : void 0));
const Runbook = reactExports.lazy(() => __vitePreload(() => import("./Runbook-5Aeuitu2.js"), true ? __vite__mapDeps([7,3,1]) : void 0));
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 font-mono text-sm text-primary", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-4 bg-primary animate-pulse" }),
